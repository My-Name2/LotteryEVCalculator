...
def calculate_ev(odds, payout, ticket_cost, tax_rate, instant_payout):
...
if st.button("Calculate EV"):
    ev, net_payout, effective_probability = calculate_ev(odds, payout, ticket_cost, tax_rate, instant_payout)
